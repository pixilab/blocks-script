...
define(["require", "exports", "../system/SimpleHTTP", "../system_lib/Driver", "../system_lib/Metadata"], function (require, exports, SimpleHTTP_1, Driver_1, Metadata_1) {
    ...
    var ShellyHTTP = exports.ShellyHTTP = (function (_super) {
        ...
        Object.defineProperty(ShellyHTTP.prototype, "relay2", {
            get: function () {
                return this._relay2;
            },
            set: function (on) {
        ...
        Object.defineProperty(ShellyHTTP.prototype, "relay3", {
            get: function () {
                return this._relay3;
            },
            set: function (on) {
        ...
        Object.defineProperty(ShellyHTTP.prototype, "relay4", {
            get: function () {
                return this._relay4;
            },
            set: function (on) {
        ...
        ShellyHTTP.prototype.makeRelayRequest = function (relayIndex, on) {
            return __awaiter(this, void 0, void 0, function () {
                var state;
                return __generator(this, function (_a) {
                    state = on ? 'on' : 'off';
                    return [2, SimpleHTTP_1.SimpleHTTP.newRequest("http://".concat(this.socket.address, "/relay/").concat(relayIndex, "?turn=").concat(state)).get()];
                });
            });
        };
        __decorate([

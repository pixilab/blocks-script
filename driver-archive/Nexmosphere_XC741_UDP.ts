/**
 * PIXILAB Blocks driver for the Nexmosphere XC-741-U controller using UDP transport.
...
export class Nexmosphere_XC741_UDP extends NexmosphereBase<NetworkUDP> {

...
define(["require", "exports", "system_lib/Driver", "system_lib/Metadata"], function (require, exports, Driver_1, Metadata_1) {
    ...
    var HelvarNet = (function (_super) {
        ...
        __decorate([
            ...
            __param(0, Metadata_1.parameter("Group to control")), __param(0, Metadata_1.min(1)), __param(0, Metadata_1.max(16383)),
            __param(1, Metadata_1.parameter("Scene number to recall")), __param(1, Metadata_1.min(1)), __param(1, Metadata_1.max(16)),
            __param(2, Metadata_1.parameter("Scene block", true)), __param(2, Metadata_1.min(1)), __param(2, Metadata_1.max(8)),
            __param(3, Metadata_1.parameter("Transition time, in seconds", true)), __param(3, Metadata_1.min(1)),
        ...
        __decorate([
            ...
            __param(0, Metadata_1.parameter("Proportion, -1..1")), __param(0, Metadata_1.min(-1)), __param(0, Metadata_1.max(1)),
            __param(1, Metadata_1.parameter("Group to control, 1..16383")), __param(1, Metadata_1.min(1)), __param(1, Metadata_1.max(16383)),
